...
/// <summary>
/// Manages AR camera operations for real-time object detection in Unity using ARFoundation. 
/// It captures camera frames, processes them for object detection using YOLO models, 
/// and manages the AR scene based on detection results. This class also handles UI 
/// elements for visualizing detected objects and coordinates with ARAnchor and ARRaycastManager 
/// for spatial mapping and interaction.
/// Derived from https://github.com/derenlei/Unity_Detection2AR
/// </summary>
